...
public class MusicTrack {
     ...
     * @param style  string
     */
    public MusicTrack(final String title, final int length, final String style) throws IllegalArgumentException {
     ...
     * @param length int
     */
    public MusicTrack(final String title, final int length) throws IllegalArgumentException {
