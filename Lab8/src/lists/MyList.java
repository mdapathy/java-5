...
public class MyList<T> implements List<T> {
     ...
     */
    public T get(final int position) throws ListException {
     ...
     */
    public T remove(final int position) throws ListException {
    ...
    public boolean equals(final Object o) {
        return (this == o) || ((o instanceof MyList) && this.list.equals(((MyList) o).list));
    }
    ...
    protected class SubList extends MyList {
        ...
        public SubList(MyList parentList, int startPosition, int endPosition) throws ListException {
            if (startPosition > endPosition || parentList == null) {
                throw new ListException("Sublist cannot be initialized with such values");
            }
        ...
        public void add(int index, Object object) {
            if (index > size()) {
                throw new ListException("Cannot add value to such position");
